...
touch src/index.html src/js/index.js src/scss/styles.scss
```
...
Importing Bootstrap into Parcel requires two imports, one into our `styles.scss` and one into our `index.js`.
...
2. **Import Bootstrap's JS.** Add the following to `src/js/index.js` to import all of Bootstrap's JS. Popper will be imported automatically through Bootstrap.
