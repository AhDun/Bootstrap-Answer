...
touch src/index.html src/js/index.js src/scss/styles.scss vite.config.js
```
...
2. **Next we load the CSS and import Bootstrap's JavaScript.** Add the following to `src/js/index.js` to load the CSS and import all of Bootstrap's JS. Popper will be imported automatically through Bootstrap.
